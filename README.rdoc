...
- {Manager.lsl2}[https://github.com/nuxy/LSL-OS-Build-Box/blob/master/Manager.lsl2] (Recorder/Installer script)

- {Object.lsl2}[https://github.com/nuxy/LSL-OS-Build-Box/blob/master/Object.lsl2] (Action script)
